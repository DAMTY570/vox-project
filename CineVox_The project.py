...
#Personnaliser
fenetre.title("CineVox")
fenetre.geometry("1080x720")
fenetre.iconbitmap("logo.ico")
fenetre.config(background='#B2B036')

#boite
boite = Frame(fenetre, bg='#B2B036', bd=1, relief=SUNKEN)


#Texte
mes_wel=Label(boite, text='Bienvenue \n sur \n CineVox', font=("Courrier", 45), bg='#B2B036', fg='red' )
mes_wel.pack()
...
#ajouter bouton
btn = Button(fenetre, text="Consulter notre programmation", font=("Courrier", 15), bg='white', fg='#B2B036', command=jouer)
btn.pack(side=BOTTOM, pady=25, fill=X)
